...
export const BLOCK_REGISTRY: BlockRegistryEntry[] = [
  ...
  { type: "subsubsection_heading", label: "Sub-subheading", group: "text", icon: Heading4, kind: "owns-content", status: "available" },
  ...
  { type: "image_row", label: "Image Row", group: "visual", icon: GalleryHorizontal, kind: "owns-content", status: "available" },
