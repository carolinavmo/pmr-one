...
import { createCategoryAction } from "@/lib/actions/question-bank";
import { CARD_COLOR_SWATCH } from "@/lib/card-colors";
import type { CardColor } from "@/lib/editorial-blocks";
import { ColorSwatchPicker } from "@/components/ui/ColorSwatchPicker";
import { Button } from "@/components/ui/Button";

// Same drawer shape as Flashcards' NewCategoryDrawer, minus the
// ownerType prop — Question Bank folders are always editorial, the
// real gate is requireEditor() server-side in createCategoryAction.
