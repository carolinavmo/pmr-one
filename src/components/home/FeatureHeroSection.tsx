        ...
        <ScrollReveal>
          <div className={reverse ? "flex flex-col gap-5 lg:order-2" : "flex flex-col gap-5"}>
            <span className="flex w-fit items-center gap-2">
              <span className={`flex size-7 shrink-0 items-center justify-center rounded-full ${CARD_COLOR_CHIP[color]}`}>
                <EyebrowIcon className="size-3.5" aria-hidden="true" />
              </span>
              <span className={`font-ui text-xs font-semibold tracking-wide uppercase ${CARD_COLOR_TEXT[color]}`}>
                {eyebrowLabel}
              </span>
            </span>
