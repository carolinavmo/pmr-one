    ...
    <div className="flex items-center gap-2">
      <div className="min-w-0 flex-1">
        <EditableText
          ...
          multiline={false}
          className={`scroll-mt-36 rounded-[4px] px-3 py-2 font-section-heading text-[26px] leading-[32px] font-normal !bg-[#128A99] !text-white lg:scroll-mt-24 ${TEXT_ALIGN_CLASS[textAlign]}`}
          value={block.text}
          onSave={async (value) => {
